  ...
  return (
    <header className="fixed top-2 w-full z-50">
      <div className="max-w-7xl mx-auto px-6 py-3">
        <div className="flex items-center justify-between h-16 w-full px-6 rounded-full bg-white/10 text-white border border-white/20 hover:bg-white/15 hover:border-white/30 transition-colors duration-200 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)] backdrop-blur-md">
