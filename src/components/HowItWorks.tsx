          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative h-full min-h-[300px] flex flex-col items-center text-center bg-white/5 backdrop-blur-md ring-1 ring-white/10 rounded-2xl p-8 hover:ring-white/20 transition-all duration-300 hover:bg-white/10 will-change-transform"
                  style={{
                    transform:
